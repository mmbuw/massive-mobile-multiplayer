...
InputHandler::InputHandler() : updateDeviceListThreadRunning_(true), inputValueThreadRunning_(true)
{
    if (getuid() != 0)
    {
...
void InputHandler::updateDeviceList()
{
    while (updateDeviceListThreadRunning_)
    {
        ...
        /* Search if new event devices have been added or removed */
        /* TODO for application developer: adjust name of input devices to look for one line below */
...
{
    /* checks the active event devices for new events */
    /* TODO for application developer: react to events (see below) */
        ...
        if (retval)
        {
            ...
            for (int i = 1; i < maxDescriptor+1; ++i)
            {
                if (FD_ISSET(i, &rfds))
                {
                    ...
                    /* TODO for application developer: react to possible events here */
                    /* An example is given for a button event and (x,y) relative events */
...
{
    /* Called when a new input device is recognized */
    /* TODO for application developer: implement proper application reaction */
...
{
    /* Called when an event device was removed */
    /* TODO for application developer: implement proper application reaction */
...
{
    /* Asynchronously process the queries of new and removed devices */
    /* nothing to do for the application developer here */
...
{
    /* Calls every active input device to apply the stored input values of this frame */
    /* nothing to do for the application developer here */
